...
int main(int argc, char *argv[]) {
	...
	cout << "before dungeon game" << endl;
    // Build dungeon
    dungeon dungeonGame;
	cout << "after dungeon game" << endl;
    // Room 1: Entry Hall
    ...
    std::vector<std::string> grid6 = { /* your 50x25 maze */ };
    room* r6 = new room("The final chamber, glowing with victory", grid6, true);
    dungeonGame.addRoom(r6);

    // Link rooms
    cout << "Before linking rooms" << endl;
    linkRooms(r1, r2, 14, 29);
    cout << "After linking rooms" << endl;
    linkRooms(r2, r3, 10, 10);
    linkRooms(r3, r4, 20, 5);
    linkRooms(r4, r5, 25, 12);
    linkRooms(r5, r6, 30, 20);
    ...
    // Add enemies/items
    cout << "setting enemies" << endl;
    r1->setEnemy(new goblin(11,9));
    r1->addHiddenEnemy(11,9);
    r1->setEnemy(new goblin(1,6));
    r1->addHiddenEnemy(1,6);
    cout << "after setting enemies" << endl;
    r2->setEnemy(new skeleton(15,15));
    r2->addHiddenEnemy(15,15);
    r3->setEnemy(new mage(20,20));
    r3->addHiddenEnemy(20,20);

    cout << "before setting items" << endl;
    ...
    cout << "after setting items" << endl;

    // Main loop
    while (true) {
      	cout << "before first draw" << endl;
